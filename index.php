...
<body class="bg-[#eef6fc] min-h-screen flex items-center justify-center w-screen overflow-hidden">
    <div class="w-full max-w-6xl h-[90vh] bg-white rounded-2xl shadow-2xl flex overflow-hidden">
        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center relative bg-white">
            ...
            <form id="loginForm" method="POST" action="" class="space-y-4">
                ...
                <div>
                    <label for="username" class="block mb-1 text-sm text-gray-600 font-medium">Email or phone</label>
                ...
                <div>
                    <label for="password" class="block mb-1 text-sm text-gray-600 font-medium">Password</label>
    ...
    <div id="forgotPasswordPopup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h3 class="text-xl font-semibold mb-3 text-center">Forgot Password</h3>
            <form id="forgotPasswordForm" class="space-y-4">
                <div>
                    <label for="forgotUsername" class="block text-sm font-medium text-gray-600 mb-1">Email or Phone</label>
                    <input type="text" id="forgotUsername" name="input" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400" required />
                </div>
                <button type="button" onclick="sendOTP()" class="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition">Send OTP</button>
            </form>
            ...
            <div id="resetSection" class="hidden mt-4">
                <form id="resetPasswordForm" class="space-y-4">
                    ...
                    <button type="button" onclick="resetPassword()" class="w-full bg-orange-500 text-white py-2 rounded-md hover:bg-orange-600 transition">Reset Password</button>
                </form>
            </div>
            <button id="closeForgotPopup" class="mt-4 w-full text-sm text-gray-600 hover:underline text-center">Close</button>
        </div>
    </div>
